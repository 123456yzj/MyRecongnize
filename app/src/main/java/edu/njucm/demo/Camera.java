...
public class Camera extends Activity {
    ...
    public void saveToSystemGallery(Bitmap bmp) {
        ...
        String faceColor=FaceProgram(fileName);
        Log.d(TAG,"face: "+faceColor.toString());
    ...
    class FaceProgram(String fileName){
        Python py = Python.getInstance();
        py.getModule("Face_recongnize").callAttr("runProgram",filename);
